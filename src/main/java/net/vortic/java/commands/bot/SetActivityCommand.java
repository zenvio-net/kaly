package net.vortic.java.commands.bot;
...
public class SetActivityCommand extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(SlashCommandInteractionEvent event) {
        ...
        TextInput reason = TextInput.create("activity_text", "Activity Text", TextInputStyle.SHORT)
                .setMinLength(5)
                .setMaxLength(100)
                .setRequired(true)
        ...
        TextInput messageURL = TextInput.create("activity_type", "Activity Type", TextInputStyle.SHORT)
                .setMinLength(5)
                .setMaxLength(10)
                .setRequired(true)
        ...
        event.replyModal(Modal.create("activity_modal", "Change Activity of Kaly")
                .addActionRow(reason)
